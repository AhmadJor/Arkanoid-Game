...
public class GameLevel implements Animation {
    ...
    private final java.util.ArrayList<Ball> listBalls;
    private final java.util.ArrayList<Block> listOfBlocks;
    ...
    private final Counter gameCount;
    ...
    public void createBorders() {
        ...
        listBlocks.add(new Block(new Rectangle(new Point(0, 0), 20, HEIGHT), Color.GRAY));
        listBlocks.add(new Block(new Rectangle(new Point(780, 0), 20, HEIGHT), Color.GRAY));
        listBlocks.add(new Block(new Rectangle(new Point(WIDTH - 10, 20), 10, HEIGHT),
                Color.GRAY));
    ...
    public void initialize() {
        ...
        for (int i = 0; i < levelInformation.numberOfBalls(); i++) {
            Ball b = new Ball(new Point(400, 550), 5, Color.gray, this.environment);
        ...
        BlockRemover blockRemover = new BlockRemover(this, blockCount);
        ...
        CountdownAnimation countdownAnimation = new CountdownAnimation(this.sprites);
